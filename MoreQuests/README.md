...
| Festival | Rainbow Platter (Trout Derby) | Summer 19 | Gus / Pika / Rosa / Celestine | Catch Rainbow Trout during the Derby (qty scales with Fishing) | Recipe + shop discount on the dish in the giver's saloon shop | DateLocked, OneTimePerYear, deadline Summer 22 | Implemented |
...
| Festival | Secret Gift Hint | Talk to Lewis Winter 22-25 | Lewis | Give your secret-friend recipient a loved/liked item at the Winter Star festival exchange | Friendship (Mid) with the recipient | NpcDialogue, opt-out via config, deadline 4 days, completes only on the festival's secret-santa gift | Implemented |
