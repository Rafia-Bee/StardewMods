...
// flavor-named ("lights", "rug", "chair"); rooms don't matter, only the type does.
internal static class FurnitureCategory
{
    ...
    public static readonly string[] All = { Light, Rug, Chair, Table };
    ...
    public static bool Matches(Furniture f, string category)
    {
        ...
        {
            Light => t == Furniture.lamp || t == Furniture.sconce || t == Furniture.torch || t == Furniture.fireplace,
            Rug => t == Furniture.rug,
    ...
    public static string I18nKey(string category) => "objective." + category;
}
